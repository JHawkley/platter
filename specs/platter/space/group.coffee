`import Group, { Methods as methGroup, Type as tGroup } from 'platter/space/group'`
`import { Node, Methods as methNode } from 'platter/space/node'`
  ...
  describe 'methods', ->
    ...
    describe 'include', ->
      ...
      it 'should add a type to the included filter', ->
        ...
        methGroup.include.apply.call(test, tTestBox)
      ...
      it 'should add several types to the included filter', ->
        ...
        methGroup.include.apply.call(test, [tTestBox, tGroup])
      ...
      it 'should include all if no types are specified', ->
        ...
        methGroup.include.finalize.call(test)
    ...
    describe 'exclude', ->
      ...
      it 'should add a type to the excluded filter', ->
        ...
        methGroup.exclude.apply.call(test, tTestBox)
      ...
      it 'should add several types to the allowed filter', ->
        ...
        methGroup.exclude.apply.call(test, [tTestBox, tGroup])
    ...
    describe 'setType', ->
      ...
      it 'should set a type of `group`', ->
        test = { type: [] }
        methGroup.setType.finalize.call(test)

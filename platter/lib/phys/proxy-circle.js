define(['exports', 'module', '../factory/base', './proxy-base', '../geom/_support', '../math/matrix', '../math/vector-math'], function (exports, module, _factoryBase, _proxyBase, _geom_support, _mathMatrix, _mathVectorMath) {
  ...
  proxyCircleFactory = new _Factory['default']((function (superClass) {
    ...
    _Class.prototype.support = function (out, v) {
      return (0, _geom_support.circle)(out, this, v);
    };

    _Class.prototype.toRect = function (out, synced) {
      var d, i, len, maxX, maxY, minX, minY, node, nodes, r, ref, ref1, ref2, ref3, x, y;
      if (synced == null) {
        synced = false;
      }
      r = this.radius;
      ...
      if (synced) {
        ...
        if (nodes.length > 0) {
          ...
          out.setProps(minX + x - r, minY + y - r, maxX - minX + d, maxY - minY + d);
        } else {
  ...
  module.exports = proxyCircleFactory;
});

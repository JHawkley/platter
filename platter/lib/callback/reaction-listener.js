define(['exports', 'module', './options', './events', './exceptions', '../utils/array'], function (exports, module, _options, _events, _exceptions, _utilsArray) {
  ...
  var ReactionListener, registeredListeners, sortFn;
  ...
  ReactionListener = (function () {
    ReactionListener.findMatches = function (a, b, event, exception) {
    ...
    function ReactionListener(eventFlags, opt1, opt2, optionsHash, fn) {
      var exception, ref;
    ...
    ReactionListener.prototype.register = function () {
      if (!this.registered) {
    ...
    ReactionListener.prototype.unregister = function () {
      var i;
      if (this.registered) {
    ...
    ReactionListener.prototype.test = function (a, b) {
      var aType, bType;
      aType = a.type;
      bType = b.type;

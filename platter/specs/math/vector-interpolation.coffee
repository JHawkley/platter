...
describe 'platter: math, vector interpolation', ->
  ...
  describe 'node management', ->
    ...
    it 'should initialize empty', ->
      expect(interp.nodes.length).toBe 0
    ...
    describe 'add()', ->
      ...
      it 'should add nodes at a default position of 1.0', ->
        ...
        expect(interp.nodes.length).toBe 1
        expect(interp.nodes[0].pos).toBe 1.0
        expect(vEquals(interp.nodes[0].value, v)).toBe true
      ...
      it 'should add nodes at a specified position', ->
        ...
        expect(interp.nodes.length).toBe 1
        expect(interp.nodes[0].pos).toBe 0.5
        expect(vEquals(interp.nodes[0].value, v)).toBe true
      ...
      it 'should sort nodes by position as they are added', ->
        ...
        expect(vEquals(interp.nodes[0].value, v3)).toBe true
        expect(vEquals(interp.nodes[1].value, v2)).toBe true
        expect(vEquals(interp.nodes[2].value, v1)).toBe true
    ...
    describe 'clear()', ->
      ...
      it 'should be able to clear all nodes', ->
        ...
        expect(interp.nodes.length).toBe 3
    ...
    describe 'set()', ->
      ...
      it 'should clear and then add a node at position 1.0', ->
        ...
        expect(interp.nodes.length).toBe 1
        expect(interp.nodes[0].pos).toBe 1.0
        expect(vEquals(interp.nodes[0].value, v4)).toBe true
    ...
    describe 'divert()', ->
      ...
      it 'should retain the value at a certain position, after setting 1.0 to a new value', ->
        ...
        expect(interp.nodes.length).toBe 2
